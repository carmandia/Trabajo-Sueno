...
```
  ...
  <div class="col-6">
<p>Al igual que en el caso anterior parece que vuelven a ser muy similares las pulsaciones independientemente de la enfermedad que presente el individuo. Lo único que podríamos destacar es que los individuos con apnea del sueño la tienen algo mas alta</p>
  </div>
</div>
...
# Ocupación laboral e indice de masa corporal {data-navmenu="Estudio de influencia en la variable objetivo"}
...
Particionamos los datos en predictoras y objetivo teniendo en cuenta que tenemos que mantener esta proporción.
...
### Conclusiones
Podemos ver que el rendimiento de nuestro modelo es en general malo, pues no detecta de manera correcta la apnea del sueño y el insomnio. Viendo representada la matriz de confusión, como sospechábamos siempre clasifica en que no tienen enfermedad los sujetos. Vamos a representarlos en una gráfica donde seguramente veremos que con este modelo no se pueden separar bien los datos.
...
### Conclusiones
El modelo es ligeramente mejor, puesto que si clasificamos de manera correcta algunos casos de pacientes con insomnio. Pasamos a ver la matriz de confusión también, y nos percatamos que el modelo clasifica peor la clase de no enfermedad, puesto que hay muchas personas que no presentan enfermedad y que las trata como si tuvieran insomnio. 
...
### Conclusiones
Tenemos un modelo de un rendimiento muy similar al primero a simple vista de las métricas. Volvemos a visualizar la matriz de confusión.
...
### Conclusiones
Tenemos un modelo similar al primero de nuevo, veamos en la matriz de confusión y nos daremos cuenta de que es similar a los modelos Naive Bayes y Decision Tree.
